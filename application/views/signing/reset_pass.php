                ...
                <div class="col-md-7 col-md-offset-2 tiles gray no-padding">
                    ...
                    <div class=" grey p-t-20 p-b-20 text-black"><!--colorgrey-->
                        <div class="col-md-8 form-container">
                            <form id="frm_login" class="animated fadeIn" action="<?php echo site_url('/login/reset_pass_submit'); ?>" method="post">      
                                <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                                    <?php echo validation_errors() ?>
                                </div>
                                <?php if (!empty($message)) { ?> <div class="alert alert-danger"><?php echo urldecode($message); ?></div><?php } ?>
                                ...
                                <div class="row form-row m-l-10 m-r-10 xs-m-l-5 xs-m-r-5">
                                    <div class="col-md-12 col-sm-12">
                                        <input name="repassword" id="password" type="password"  class="form-control" placeholder="Confirm Password">
