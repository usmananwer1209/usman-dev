...
!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<select class='bootstrap-wysihtml5-insert-image-url m-wrap large' id='comp' onchange='return select_val();'><option value='1'>Apple</option><option value='1'>Amazon</option></select><input name='comp_id' id='comp_id' value='' class='bootstrap-wysihtml5-insert-link-url m-wrap large' type='hidden'>" +
                "</div>" +
                ...
                "</div>" +
                "</div></div></div>" +
                "<a class='btn btn-white hide" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' data-toggle='modal' data-target='#linkmodal'><i class='fa fa-tag'></i></a>" +
                "</li>";
        },
    ...
    Wysihtml5.prototype = {
        ...
        initInsertLink: function(toolbar) {
            ...
            toolbar.find('a[data-wysihtml5-command=createLink]').click(function() {
                ...
                var activeButton = $(this).hasClass("wysihtml5-command-test");
    ...
    $( ".wysiwyg_description wysihtml5-editor a" ).click(function() {
        alert( "Handler for .click() called." );
    });
}(window.jQuery, window.wysihtml5);

function select_val(id,type,styleclass) {
    var title = $('#' + id).text();
    var tagclass = '';
    if (styleclass == 1) {
        tagclass = 'link-border';
    }
    else if (styleclass == 2) {
        tagclass = 'link-arrow';
    }
    else if (styleclass == 3) {
        tagclass = 'link-scaleup';
    }
    if (type == 1) {
        self.editor.currentView.element.focus();
        self.editor.composer.commands.exec("createLink", {
